...
const Footer = () => {
	return (
		<footer className="w-full mt-16 border-t border-border/40 py-12 px-6 text-muted-foreground text-xs text-center transition-all duration-300">
			<div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
				{/* Follow me */}
				<div className="flex flex-col items-center md:items-start gap-3">
					<h5 className="text-[10px] uppercase tracking-widest font-bold text-foreground">Follow Me</h5>
					<div className="flex items-center gap-4">
						<Link
							href="https://x.com/Laplusdestiny"
						...
						<Link
							href="https://misskey.io/@Laplusdestiny"
						...
						<Link
							href="https://github.com/Laplusdestiny"
							className="text-muted-foreground hover:text-foreground transition-colors duration-300"
							aria-label="GitHub"
							target="_blank"
							rel="noopener noreferrer"
						>
							<FontAwesomeIcon icon={faSquareGithub} className='h-5 w-5' />
						</Link>
						<Link
							href="https://bsky.app/profile/laplusdestiny.com"
							className="text-muted-foreground hover:text-foreground transition-colors duration-300"
							aria-label="Bluesky"
							target="_blank"
							rel="noopener noreferrer"
